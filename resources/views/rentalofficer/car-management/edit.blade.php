    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-header pb-3 d-flex justify-content-between">
                <span>{{ __('Edit car') }}</span>
                <a href="/car-management" class="btn btn-info btn-sm">Cancel</a>
            </div>


            <form method="post" action="/car-management/{{ $car->id }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('name') ?? $car->name }}" id="name" name="name" placeholder="Car name"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('plate_number') ?? $car->plate_number }}" id="plate_number"
                            name="plate_number" placeholder="Plate number"
                            class="form-control  @error('plate_number') is-invalid @enderror" type="text">
                        @error('plate_number')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('price_with_driver') ?? $car->price_with_driver }}" id="price_with_driver"
                            name="price_with_driver" placeholder="Price with driver"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('price_with_out_driver') ?? $car->price_with_out_driver }}"
                            id="price_with_out_driver" name="price_with_out_driver" placeholder="Price with out driver"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('model') ?? $car->model }}" id="model" name="model" placeholder="Car model"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('seat_capacity') ?? $car->seat_capacity }}" id="seat_capacity"
                            name="seat_capacity" placeholder="Car seat capacity"
                ...
                {{-- car_status --}}
                <div class="form-group row">
                    <label for="editor" class="col-12 col-form-label">Car status</label>
                    <div class="col-12">
                        <textarea name="car_status" class="editor" rows="10"
                            value="{!! old('car_status') ?? $car->car_status !!}"></textarea>
                    </div>
                    @error('car_status')
                    <span class="text-danger pl-4" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    @enderror
                </div>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <button name="submit" type="submit" class="btn btn-primary">Update Car</button>
                    </div>
                </div>
